...
namespace
{
	...
	DXGI_FORMAT PixelFormatTable[CodeEngine::kMaxPixelFormats] =
	{
	...
	D3D11_FILTER FilterTable[CodeEngine::kMaxTextureFilters] =
	{
	...
	struct PipelineState
	{
		...
		CodeEngine::VertexShaderHandle	vertexShader;
		CodeEngine::PixelShaderHandle		pixelShader;
