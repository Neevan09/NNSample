...
namespace CodeEngine
{
	...
	struct Frustum
	{
		...
		TF_INLINE void Transform(const Transform& t);
		TF_INLINE void TransformWithoutScaling(const CodeEngine::Transform& t);
	...
	TF_INLINE void BoundingSphere::Transform(const CodeEngine::Transform& t)
	{
	...
	TF_INLINE void BoundingBox::Transform(const CodeEngine::Transform& t)
	{
	...
	TF_INLINE void OrientedBoundingBox::Transform(const CodeEngine::Transform& t)
	{
	...
	TF_INLINE void Frustum::Transform(const CodeEngine::Transform& t)
	{
		orientation = t.GetRotation() * orientation;
	...
	TF_INLINE void Frustum::TransformWithoutScaling(const CodeEngine::Transform& t)
	{
		orientation = t.GetRotation() * orientation;
		origin = t.TransformPosition(origin);
	}
