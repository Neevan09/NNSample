...
namespace CodeEngine
{
	...
	int32_t SceneManager::LoadSceneEntity(const rapidjson::Value& value, CodeEngine::TransformComponent parent)
	{
	...
	int32_t SceneManager::LoadComponents(const rapidjson::Value& value, CodeEngine::Entity e)
	{
		if (!e)
		{
			return kErrUnknown;
	...
	CodeEngine::math::float3 SceneManager::GetPlayerSpawnPoint()
	{
		return pSpawnPoint;
	}
}
