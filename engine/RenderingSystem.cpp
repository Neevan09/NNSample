...
namespace
{
	...
	{
		PointLight				lights[CodeEngine::kMaxPointLights];
		uint32_t				numLights;
		float					padding[3];
	};
	...
	{
		SpotLight				lights[CodeEngine::kMaxSpotLights];
		uint32_t				numLights;
		float					padding[3];
	};
	...
	{
		DirectionalLight		directionalLights[CodeEngine::kMaxDirectionalLights];
		float4					ambient;
	};
